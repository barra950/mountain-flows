...
Brange = np.arange(-0.1,0.11,0.01)
Vrange = np.arange(-4,4.5,0.5)
Urange = np.arange(-14,15,1)
Wrange = np.arange(-6.2,6.3,0.2)
Prange = np.arange(-10,10.5,0.5)
Ustarrange = np.arange(-14,6,2)
Ustarylim = [-14,4]
